...
drawBoard b angle hFact fillColour lineColour = 
  ...
  [ drawPoly (vertsForCell (0.0 * toFloat (b.cellWidth) + (0.0 * toFloat (b.cellWidth) / tan 45)) (toFloat (b.cellWidth) * toFloat (b.dimY) - (0.0 * hFact * toFloat (b.cellWidth))) (toFloat (b.cellWidth)) angle hFact) fillColour lineColour []
  , drawPoly (vertsForCell (1.0 * toFloat (b.cellWidth) + (0.0 * toFloat (b.cellWidth) / tan 45)) (toFloat (b.cellWidth) * toFloat (b.dimY) - (0.0 * hFact * toFloat (b.cellWidth))) (toFloat (b.cellWidth)) angle hFact) fillColour lineColour []
  , drawPoly (vertsForCell (2.0 * toFloat (b.cellWidth) + (0.0 * toFloat (b.cellWidth) / tan 45)) (toFloat (b.cellWidth) * toFloat (b.dimY) - (0.0 * hFact * toFloat (b.cellWidth))) (toFloat (b.cellWidth)) angle hFact) fillColour lineColour []
  , drawPoly (vertsForCell (3.0 * toFloat (b.cellWidth) + (0.0 * toFloat (b.cellWidth) / tan 45)) (toFloat (b.cellWidth) * toFloat (b.dimY) - (0.0 * hFact * toFloat (b.cellWidth))) (toFloat (b.cellWidth)) angle hFact) fillColour lineColour []
  , drawPoly (vertsForCell (4.0 * toFloat (b.cellWidth) + (0.0 * toFloat (b.cellWidth) / tan 45)) (toFloat (b.cellWidth) * toFloat (b.dimY) - (0.0 * hFact * toFloat (b.cellWidth))) (toFloat (b.cellWidth)) angle hFact) fillColour lineColour []
